...
+ **Tumbling window trigger** : 
  + Même fonctionnement qu'au-dessus : 
    ...
    + Possibilité d'ajouter un délai : 
      ...
      + Un pipeline avec un TW trigger avec une fréquence de 30 minutes et un délai de 2 minutes aura des fenêtres de 30 minutes (01:00 --> 01:30 --> 2:00 --> ...) mais le pipeline exécutera en décalage de 2 minutes (01:02 --> 01:32 --> 02:02 --> ... + 2 min).
+ Possibilité de visualiser du temps réel avec Azure Stream Analytics, Event Hub en entrée et un dashboard Power BI en sortie.  
+ **Modify the job to accept data generated by the IoT devices in the Protobuf format instead of JSON** : 
  ...
  + Change input.json and reference DLL. 
...
![image-20221214004006561](Images/IntegrationRuntime.PNG)
